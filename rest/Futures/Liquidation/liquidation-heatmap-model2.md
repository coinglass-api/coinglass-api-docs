# Futures - Liquidation - Pair Liquidation Heatmap Model2
...
| -------- | ------ | --------- | ------------------------------------------------------------------------------------------------------- |
| exchange | string | YES       | Exchange name  eg. Binance ，OKX （ Check supported exchanges through the 'supported-exchange-pair' API.） |
| symbol   | string | YES       | Trading pair eg. BTCUSDT   （ Check supported pair through the 'supported-exchange-pair' API.）           |
| range    | string | YES       | 12h, 24h, 3d, 7d, 30d, 90d, 180d, 1y                                                                    |
